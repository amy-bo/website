...
Please add a comment to one of [our YouTube videos](https://www.youtube.com/@AMYBO) or drop us a line at [our contact form](https://contact.andeye.com/?source=amybo.org&subject=Message%20from%20amybo.org&cb=Volunteering&cb=Running%20an%20experiment&cb=Building%20an%20electroPioreactor&cb=Funding%20or%20sponsorship&cb=Press%20or%20speaking&cb=Something%20else) with any suggestions or questions you may have - or just to say hello, it's good to know people are reading this.
...
Since we'll be using GitHub for software development, and potentially also for hardware and procedure development, it made sense to use this for community development of the website.  If you struggle at all with GitHub development, please get in touch via [our contact form](https://contact.andeye.com/?source=amybo.org&subject=Message%20from%20amybo.org&cb=Volunteering&cb=Running%20an%20experiment&cb=Building%20an%20electroPioreactor&cb=Funding%20or%20sponsorship&cb=Press%20or%20speaking&cb=Something%20else)
