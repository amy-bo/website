...
source: hugo
hugoPath: /docs/experiments/control-testing/
sidebar:
  order: 3
provenance: "Moved from the old Docs section in the 2026 relaunch; text unchanged. Presentation: an absolute link to the old /docs/ URL made relative to its new page."
---
...
![A bunsen burner, small weight scale, three vials and a dropper. Two of the vials contain YPD broth and are covered with aluminium foil. The other vial contains stock solution.](./control-testing/equipment.jpg)

## Kit List
1. 2 x [Pioreactor 20 ml](https://pioreactor.com/products/pioreactor-20ml?variant=46559156469816) - [see our thoughts on Pioreactors](/projects/past/equipment/bioreactors/#pioreactor)
...
![Using a pressure cooker on a gas stove as an autoclave](./control-testing/autoclaving.jpg)
...
![Two Pioreactors standing side by side, with the one on the right connected to a Raspberry Pi 400](./control-testing/pioreactors.jpg)

## Results

The raw results from the experiment are [available as CSV files on GitHub](https://github.com/amy-bo/results/tree/main/Control%20Testing).

![A screenshot of the Pioreactor results](./control-testing/results.png)

## Report

### Watch Gerrit's report his results

<YouTube id="gIxau_YtKr0" title="Watch Gerrit's report his results" />
